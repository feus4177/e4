    ...
    return (
      <div className="container">
        ...
        <p className="lead">
          ...
          these terms and conditions, you consent to e4's use of cookies in
          accordance with the terms of e4's cookies policy.
        </p>

        <h2>License to use Website</h2>
        <p>
          Unless otherwise stated, e4 and/or its licensors own the intellectual
        ...
        <p>
          ...
          website without e4's express written consent.
        </p>
        <p>
        ...
        <p>
          ...
          without e4's express written consent.
        </p>

        <h2>Restricted Access</h2>
        <p>
          e4 reserves the right to restrict access to areas of this
          website, or indeed this entire website, at e4's discretion.
        </p>
        <p>
          If e4 provides you with a user ID and password to enable you to
        ...
        <p>
          e4 may disable your user ID and password in e4's sole discretion
        ...
        <p>
          You grant to e4 a worldwide, irrevocable, non-exclusive, royalty-free
          ...
          e4 the right to sub-license these rights, and the right to bring an
        ...
        <p>
          ...
          rise to legal action whether against you or e4 or a third party (in
        ...
        <p>
          e4 reserves the right to edit or remove any material submitted to
          this website, or stored on e4's servers, or hosted or published upon
          this website.
        </p>
        <p>
          Notwithstanding e4's rights under these terms and conditions in
          relation to user content, e4 does not undertake to monitor the
        ...
        <p>
          ...
          warranties, express or implied. e4 makes no representations or
          warranties in relation to this website or the information and
          materials provided on this website.
        </p>
        <p>
          Without prejudice to the generality of the foregoing paragraph, e4
        ...
        <p>
          e4 will not be liable to you (whether under the law of contact, the
        ...
        <p>
          These limitations of liability apply even if e4 has been expressly
        ...
        <p>
          ...
          nothing in this website disclaimer will exclude or limit e4's
          liability in respect of any:
        </p>
        <ul>
          <li>death or personal injury caused by e4's negligence;</li>
          <li>fraud or fraudulent misrepresentation on the part of e4; or</li>
          <li>
            matter which it would be illegal or unlawful for e4 to exclude or
            limit, or to attempt or purport to exclude or limit, its
            liability.
          </li>
        </ul>
        ...
        <h2>Other Parties</h2>
        <p>
          You accept that, as a limited liability entity, e4 has an interest in
          limiting the personal liability of its officers and employees. You
          agree that you will not bring any claim personally against e4's
        ...
        <p>
          ...
          disclaimer will protect e4's officers, employees, agents,
          subsidiaries, successors, assigns and sub-contractors as well as e4.
        </p>
        ...
        <h2>Indemnity</h2>
        <p>
          You hereby indemnify e4 and undertake to keep e4 indemnified against
          any losses, damages, costs, liabilities and expenses (including
          without limitation legal expenses and any amounts paid by e4 to a
          third party in settlement of a claim or dispute on the advice of e4's
          legal advisers) incurred or suffered by e4 arising out of any breach
        ...
        <p>
          Without prejudice to e4's other rights under these terms and
          conditions, if you breach these terms and conditions in any way, e4
          may take such action as e4 deems appropriate to deal with the breach,
        ...
        <h2>Variation</h2>
        <p>
          e4 may revise these terms and conditions from time-to-time. Revised
        ...
        <h2>Assignment</h2>
        <p>
          e4 may transfer, sub-contract or otherwise deal with e4's rights
        ...
        <p>
          ...
          you and e4 in relation to your use of this website, and supersede all
        ...
        <p>
          ...
          accordance with Idaho and US law, and any disputes relating to these
          terms and conditions will be subject to the non-exclusive
          jurisdiction of the courts of Idaho.
        </p>
        <h2>Credit</h2>
        <p>
